<x-app-layout>
    <x-slot name="title">كتابة مقال جديد</x-slot>

    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <h1 class="text-2xl font-bold text-gray-900 mb-8">مقال جديد</h1>
        ...
        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <x-text-input id="title" name="title" type="text" class="mt-1 block w-full"
                    value="{{ old('title') }}" placeholder="عنوان المقال..." autofocus />
            ...
            <div>
                ...
                <x-text-input id="tags" name="tags" type="text" class="mt-1 block w-full"
                    value="{{ old('tags') }}" placeholder="تقنية, برمجة, Laravel" />
            ...
            <div>
                ...
                <textarea id="content" name="content" rows="18"
                    ...
                    placeholder="اكتب مقالك هنا...">{{ old('content') }}</textarea>

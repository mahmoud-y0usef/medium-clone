<x-editor-layout>
    ...
    <div style="position:sticky; top:0; z-index:40; border-bottom:1px solid #e5e7eb; background:#fff; padding:0.7rem 1.5rem; display:flex; align-items:center; justify-content:space-between; gap:1rem;">
        <span style="font-size:0.9rem; color:#9ca3af; font-style:italic;">New Story</span>
        <div style="display:flex; align-items:center; gap:0.75rem;">
            <button type="submit" form="story-form" name="publish" value="1"
            ...
            <button type="submit" form="story-form"
            ...
            <a href="{{ route('dashboard') }}" style="font-size:1rem; color:#9ca3af; text-decoration:none; line-height:1;">&times;</a>
        </div>
    </div>

    <div style="max-width:52rem; margin:0 auto; padding:3rem 1.5rem 6rem;">
        <form id="story-form" action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" style="display:flex; flex-direction:column; gap:1.5rem;">
            @csrf
            ...
            <div>
                ...
                {{-- Hidden textarea holds HTML on submit --}}
